      ...
      <div class="row">
        ...
        <div class="column">
          <form action="/action_page.php">
            ...
            <textarea id="subject" name="Items" placeholder="Clothes with quantity" style="height:170px"></textarea>
...
$Contact = $Location = $Items = $Name = $Email NULL;
$Contacterr = $Locationerr = $Itemerr = $Nameerr = $Emailerr =NULL;
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "INSERT INTO userinfo (Contact, Location, Items, Name, Email) VALUES('$Contact', '$Location', '$Items', '$Name', '$Email') ";
  if ($connection->query($sql) === TRUE) {
    echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
    <strong>Success! You have signed up successfully</strong>
  ...
  echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>Error! Already Existing data</strong> Try another data
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            </button>
          </div>';
}
